...
const TrendingProducts = () => {
  ...
  return (
    <div className="m-4 sm:m-10">
      <div className="flex flex-col items-center justify-center text-xl m-4 sm:m-10">
      ...
      <div className="mt-6 w-full">
        <div className="flex gap-4 overflow-x-auto scrollbar-hide px-2 lg:hidden">
          {products.map((product, index) => (
            <div
              key={index}
              className="bg-[#FFFFFF] flex-shrink-0 w-64 flex flex-col items-center justify-center rounded-2xl p-3"
            >
              <div className="flex items-center justify-between w-full">
                <div
                  className="px-5 py-2 text-white font-semibold rounded-full text-xs sm:text-sm"
                  style={{
                    background:
        ...
        <div className="hidden lg:grid grid-cols-5 gap-6 w-full">
          {products.map((product, index) => (
            <div
              key={index}
              className="bg-[#FFFFFF] flex flex-col items-center justify-center rounded-2xl p-3"
            >
              <div className="flex items-center justify-between w-full">
                <div
                  className="px-5 py-2 text-white font-semibold rounded-full text-sm"
                  style={{
                    background:
                      "linear-gradient(90deg, rgba(42,123,155,0.82) 0%, rgba(87,199,133,0.77) 100%)",
                  }}
